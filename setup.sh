...
# domain random
CDN="https://github.com/noelrubio143/vlessws/refs/heads/main/ssh/cf"
cd /root
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/noelrubio143/vlessws/refs/heads/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Instal Xray
echo -e "\e[33m-----------------------------------\033[0m"
...
wget https://raw.githubusercontent.com/noelrubio143/vlessws/refs/heads/main/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/noelrubio143/vlessws/refs/heads/main/menu/versi  )
...
echo ""
echo "====AMBER VPN LANG SAKALAM===="  | tee -a log-install.txt
echo ""
...
echo "---------------------------AMBER VPN-----------------------------" | tee -a log-install.txt
